...
export default function PolicyPage() {
  return (
    <DocShell
      title="Suspension & Ban"
      badge="Legal · Conduct"
      subtitle="Account Suspension & Ban Terms & Conditions — the complete disciplinary framework."
    >
      <p
        style={{
      ...
      {/* <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
        ...
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 1. Purpose of This Document</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 2. Who This Applies To</p>
        ...
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 4. Governing Legal Framework</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART II The Flag System</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 5. What a Flag Is</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 6. How Flags Are Issued</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 7. Flag Expiry — 1 Year</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 8. Progressive Action Table</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
        ...
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 11. Category C — Content Violations</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 12. How Violations Are Detected</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>
            PART IV Violations That Trigger Immediate Permanent Ban
          </strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 13. Severe Violations — Zero Tolerance</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 14. Company's Sole Discretion</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART V Warning Process — Flag 1</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 15. How a Warning Is Issued</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 16. Contents of a Warning Notice</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 17. Warning on Record</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 18. User's Obligation Upon Receiving a Warning</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART VI Temporary Suspension — Flag 2 &amp; Flag 3</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 19. Flag 2 Suspension — 1 Day</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 20. Flag 3 Suspension — 1 Week</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 21. How Suspension Is Applied</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 22. What Happens During Suspension</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 23. Tournament Participation During Suspension</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 24. Financial Activity During Suspension</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 25. Suspension Lifted — What Happens Next</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>
            PART VII Permanent Ban — Flag 4 &amp; Immediate Violations
          </strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 26. How a Permanent Ban Is Applied</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 27. What Permanent Ban Means</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 28. Financial Consequences of Permanent Ban</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 29. Re-Registration After Permanent Ban</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 30. Detection of Banned Users on New Accounts</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>
            PART VIII Notification of Flags, Suspensions &amp; Bans
          </strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 31. Flag Notification</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 32. Suspension Notification</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 33. Permanent Ban Notification</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 34. Contents of All Notifications</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART IX Appeal Process</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 35. Who Can Appeal</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 36. How to Submit an Appeal</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 37. What to Include in an Appeal</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 38. Appeal Review Timeline</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 39. Possible Outcomes of an Appeal</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 40. One Appeal Per Action — Finality</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART X Prohibited Post-Action Conduct</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 41. During Suspension</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 42. After Permanent Ban</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 43. During Appeal Review</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>
            PART XI Governing Law, Dispute Resolution &amp; Contact
          </strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 44. Governing Law</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 45. Dispute Resolution</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 46. Contact</p> */}
      <p
        style={{
          fontFamily: "var(--font-sub)",
          fontSize: "15px",
      ...
      >
        ...
        <li>
          Give users a meaningful opportunity to correct their behaviour through
          a progressive flag system before severe consequences are applied.
        </li>
        <li>
          Provide a legitimate appeal mechanism that ensures every user has the
          right to challenge a disciplinary action they believe is unjust.
        </li>
      </ul>
      <h2
        style={{
      ...
      >
        This Suspension Policy applies to every Registered User of the Platform
      ...
      >
        This Policy does not apply to Guest Users — Guest Users have no account
        and therefore cannot be flagged or suspended. However, Guest Users who
        create an account after engaging in behaviour that would constitute a
        violation may have that behaviour taken into account during account
        review.
      </p>
      <h2
        style={{
      ...
      >
        This Suspension Policy is a supplementary policy to the Corpse Terms
        &amp; Conditions. It is specifically referenced in:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          Corpse Terms &amp; Conditions — Section 26 (Company's Right to Suspend
          or Terminate Accounts)
        </li>
        <li>
          KYC &amp; KYC Modification Terms &amp; Conditions — Part XI (Company's
          Rights)
        </li>
        <li>
      ...
      >
        ...
        prevail. In the event of any conflict between this Suspension Policy and
        the Money Deposit &amp; Receive Policy on financial matters arising from
        suspensions or bans, the Money Deposit &amp; Receive Policy shall
        prevail.
      </p>
      <h2
        style={{
      ...
      >
        This Suspension Policy is governed by and operates within the following
        legal framework:
      </p>
      <div style={{ overflowX: "auto", marginBottom: "32px" }}>
        <table
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Corpse Terms &amp; Conditions — Corpse
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Indian Penal Code (as applicable)
              </p>
            </td>
            <td
              style={{
      ...
      >
        A flag is a formal disciplinary record placed on a user's account by the
        Company when the user is found to have violated the Platform's rules,
        community standards, or these Terms. A flag is:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          An official record — it is permanently attached to the user's account
          history for its duration and cannot be removed by the user.
        </li>
        <li>
          A warning mechanism — flags are designed to give users the opportunity
          to correct their behaviour before more severe consequences are
          applied.
        </li>
        <li>
        ...
        <li>
          ...
          date it was issued, after which it no longer counts toward the user's
          active flag total.
        </li>
      </ul>
      <p
      ...
      >
        <em>
          Note: A flag expiring after 12 months does not erase the record of the
          violation from the Company's internal audit logs. The Company retains
          all disciplinary records indefinitely for security and compliance
          purposes. Only the active flag count — which determines suspension
          consequences — resets after 12 months.
        </em>
      </p>
      <h2
        style={{
      ...
      >
        <li>
          ...
          Platform's automated detection systems, a user report, or an organiser
          report.
        </li>
        <li>
          Step 2 — The Company's trust and safety team reviews the reported
          violation and conducts an investigation to confirm whether a violation
          occurred.
        </li>
        <li>
        ...
        <li>
          Step 4 — The user is notified immediately via in-app notification and
          email of the flag, the reason for it, their current flag count, and
          the consequence triggered by the flag.
        </li>
        <li>
      ...
      >
        ...
        users before initiating an investigation. A single credible report or a
        detection by the Platform's automated systems is sufficient to trigger a
        review.
      </p>
      <h2
        style={{
      ...
      >
        <li>
          Flag expiry is calculated from the date the flag was issued — not from
          the date any suspension associated with the flag ended.
        </li>
        <li>
          If a user has 2 active flags and both expire after 12 months without a
          third flag being issued, their active flag count returns to zero.
        </li>
        <li>
          If a user receives a new flag before existing flags expire, all flags
          — old and new — remain active and count toward the user's total.
        </li>
        <li>
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                User receives Flag 1 — no prior flags
              </p>
            </td>
            <td
              style={{
      ...
      >
        The following table summarises the complete progressive action framework
        on the Platform. This is the definitive reference for all disciplinary
        consequences:
      </p>
      <div style={{ overflowX: "auto", marginBottom: "32px" }}>
        <table
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                1 calendar day from time of application
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                7 calendar days from time of application
              </p>
            </td>
            <td
              style={{
      ...
      >
        ...
        of competitive gameplay on the Platform. Each confirmed instance of any
        Category A violation results in the issuance of one flag to the user's
        account:
      </p>
      <h3
        style={{
      ...
      >
        ...
        that provides an unfair competitive advantage over other players in any
        arena or match on the Platform. This includes but is not limited to:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        <li>
          ...
          or action speed beyond normal gameplay parameters.
        </li>
        <li>
      ...
      >
        <strong>
          ...
          violation on the Platform. The Company uses multiple detection methods
          to identify cheating, including match data analysis, statistical
          anomaly detection, and organiser reports. A single confirmed instance
          of cheating results in a flag regardless of prior record.
        </strong>
      </p>
      <h3
        style={{
      ...
      >
        Deliberately manipulating the outcome of any match, arena, or tournament
        in a manner that is not consistent with genuine competitive play. This
        includes:
      </p>
      <ul
        style={{
      ...
      >
        ...
        <li>
          Deliberately losing matches — intentionally underperforming to benefit
          another player, squad, or organiser financially or competitively.
        </li>
        <li>
      ...
      >
        <li>
          Creating a secondary account to participate in the same arena as your
          primary account — gaining the ability to influence match outcomes by
          controlling multiple squads.
        </li>
        <li>
          Using multiple accounts to artificially inflate or deflate ELO
          rankings — for example, using a secondary account to deliberately lose
          matches against your primary account.
        </li>
        <li>
          Using multiple accounts to claim multiple prize positions in the same
          tournament.
        </li>
        <li>
      ...
      >
        ...
        identity element that falsely represents another registered user of the
        Platform — with the intent to deceive other users, gain an unfair
      ...
      >
        ...
        official representative of the Company in any context — including in-app
        communications, squad chats, or external social media. This is a
        particularly serious violation as it can be used to defraud other users
        or extract sensitive information under false pretences.
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <strong>
          ...
          messages, or any informal channel. If you receive such a request from
          someone claiming to be Corpse staff, report it immediately to
          <a
      ...
      >
        ...
        explicit, graphically violent, obscene, or otherwise inappropriate for a
        competitive gaming platform accessible to users of all ages. This
        includes:
      </p>
      <ul
        style={{
      ...
      >
        <li>
          Sexually explicit images, videos, or text in any profile field, squad
          name, guild name, or user-generated content field.
        </li>
        <li>
          Graphic violence or gore — images or descriptions of extreme physical
          harm.
        </li>
        <li>
      ...
      >
        NSFW and inappropriate content violations are assessed on a spectrum of
        severity. Minor violations — such as a mildly offensive username — will
        result in a flag and content removal. Severe violations — such as
      ...
      >
        <li>
          ...
          for statistical anomalies in match data, ELO progression, and account
          activity that may indicate cheating or manipulation.
        </li>
        <li>
        ...
        <li>
          ...
          investigations in response to escalated reports or flagged anomalies.
        </li>
      </ul>
      <p
        style={{
      ...
      >
        ...
        used to identify violations, as this information could be used to
        circumvent them. All investigations are conducted confidentially and
        findings are shared with the user only to the extent necessary for the
      ...
      >
        Certain violations are so severe, harmful, or fundamentally incompatible
        with the Platform's values that they result in an immediate permanent
        ban — bypassing the flag system entirely. No prior flags are required,
        and no warning is issued before the ban is applied. The following
      ...
      >
        ...
        payment details, KYC information, or Aadhaar OTPs by falsely claiming to
        be a Corpse representative or a trusted user.
      </p>
      <h3
        style={{
          fontFamily: "var(--font-ui)",
      ...
      >
        In addition to the specific categories listed in Section 13, the Company
        reserves the right to apply an immediate permanent ban at its sole
        discretion in cases where the nature, severity, or pattern of violations
        is so fundamentally incompatible with the Platform's values and
        community standards that progressing through the flag system would be
        inappropriate.
      </p>
      <p
        style={{
      ...
      >
        ...
        egregious conduct. In all cases where this discretion is exercised, the
        Company will communicate the specific reason for the immediate ban in
        the notification sent to the user and the user retains the right to
      ...
      >
        <li>
          The flag is recorded on the user's account with the date of issue, the
          violation category, and a description of the specific conduct that
          triggered the flag.
        </li>
        <li>
        ...
        <li>
          An email is sent to the user's registered email address containing the
          full warning notice as described in Section 16.
        </li>
        <li>
          No suspension is applied — the user's account remains fully active and
          accessible.
        </li>
        <li>
      ...
      >
        <li>
          The specific violation that was found to have occurred, including the
          category (Category A, B, or C) and the specific rule breached.
        </li>
        <li>
        ...
        <li>
          The user's current active flag count — for a Flag 1 warning, this will
          state '1 active flag out of a maximum of 3 before suspension.'
        </li>
        <li>
        ...
        <li>
          A reminder of the Platform's community standards and a clear statement
          of what conduct is expected going forward.
        </li>
      </ul>
      <h2
        style={{
      ...
      >
        <li>
          The warning counts as 1 active flag toward the user's cumulative flag
          total.
        </li>
        <li>
        ...
        <li>
          The user can view their active flag count and the expiry date of each
          flag within their account profile under Account &gt; Disciplinary
          Record.
        </li>
      </ul>
      <h2
      ...
      >
        ...
        <li>
          ...
          behaviour after receiving a warning will result in a second flag and a
          1-day suspension.
        </li>
        <li>
          If the user believes the warning was issued in error, submit an appeal
          within 24 hours of receiving the warning notification as described in
          Part IX.
        </li>
        <li>
      ...
      >
        ...
        point the account is automatically and fully restored without any manual
      ...
      >
        When a user accumulates a third active flag — meaning they receive a new
        flag while two previous flags are still within their 12-month validity
        periods — a temporary suspension of 7 calendar days is automatically
        applied to their account.
      </p>
      <p
        style={{
      ...
      >
        ...
        the suspension is applied. It ends exactly 168 hours (7 days) later — at
        which point the account is automatically and fully restored without any
      ...
      >
        The suspension is applied to the user's account simultaneously with the
        issuance of the flag notification. The following technical actions occur
      ...
      >
        ...
        <li>
          The suspension is enforced at the account level, not the device level
          — using a different device does not allow the user to access their
          suspended account.
        </li>
      </ul>
      <h2
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Automatically at suspension end
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Blocked — cannot create or manage arenas
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Blocked — financial activity frozen
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Released automatically at suspension end
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Held — not processed during suspension
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Profile remains visible on leaderboards
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                ELO score unaffected by suspension
              </p>
            </td>
            <td
              style={{
      ...
      >
        ...
        <li>
          If the tournament takes place during the suspension period — the squad
          may participate if another squad member is able to take the Captain
          role temporarily. This is managed within the squad — the Platform does
          not automatically reassign Captain roles during suspension.
        </li>
        <li>
      ...
      >
        ...
        <li>
          ...
          arena that concluded during or before the suspension is held in escrow
          and will be released automatically when the suspension ends.
        </li>
        <li>
          Organiser settlement — any organiser settlement pending at the time of
          suspension is held and will be processed automatically when the
          suspension ends.
        </li>
      </ul>
      <p
      ...
      >
        <li>
          ...
          suspension, and a 1-week suspension within the preceding 12 months and
          have violated the Platform's rules again.
        </li>
        <li>
          The user commits a violation classified as a zero-tolerance immediate
          permanent ban violation as described in Part IV — regardless of their
          prior flag count.
        </li>
      </ul>
      <p
      ...
      >
        A permanent ban is the termination of a user's account on the Platform.
        It is irreversible by default — the account cannot be restored,
        unlocked, or reactivated except through a successful appeal as described
        in Part IX. Upon a permanent ban:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        <li>
          The account is permanently locked — all login attempts will display a
        ...
        <li>
          All squad memberships, guild memberships, Captain roles, and organiser
      ...
      >
        ...
        <li>
          All active subscription plans (Corpse Pass, Corpse Pro, Corpse Elite)
          are cancelled immediately — no pro-rata refund is issued.
        </li>
        <li>
          All entry fees paid for upcoming or ongoing tournaments at the time of
          the ban are permanently forfeited — no refund is processed.
        </li>
        <li>
          All prize money pending disbursement at the time of the ban is
          permanently forfeited — it is not disbursed to the banned user or any
      ...
      >
        <strong>
          Important: All financial amounts associated with a permanently banned
          account are forfeited without exception. The Company does not process
          any financial disbursements to permanently banned accounts or on their
          behalf after the ban is applied. This policy exists to prevent
          financial gain from violating behaviour and is non-negotiable.
        </strong>
      </p>
      <h2
        style={{
      ...
      >
        A permanently banned user may create a new account on the Platform under
      ...
      >
        ...
        <li>
          ...
          credits, no squad memberships from the banned account are transferred.
        </li>
        <li>
      ...
      >
        <em>
          Note: Re-registration after a permanent ban is permitted as a genuine
          fresh start opportunity. However, if the new account is found to be
          engaged in the same or similar violating conduct that resulted in the
          original ban, the new account will also be permanently banned — and
          the re-registration privilege may be revoked.
        </em>
      </p>
      <h2
        style={{
      ...
      >
        <li>
          In-game ID matching — if a banned user's registered in-game IDs appear
          on a new account, this triggers a review.
        </li>
        <li>
          Behavioural pattern analysis — similar patterns of violating behaviour
          on a new account may trigger a review connecting the new account to a
      ...
      >
        If a new account is confirmed to belong to a previously banned user who
        is re-engaging in the same violating conduct:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        When a suspension is applied — whether a 1-day (Flag 2) or 1-week (Flag
        3) suspension — the user is notified immediately via both in-app
      ...
      >
        ...
        in-app notification will be visible if the user attempts to log in after
        the ban is applied.
      </p>
      <h2
        style={{
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                The user's current active flag count
              </p>
            </td>
            <td
              style={{
            ...
            >
              ...
              >
                Flag and suspension notifications
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                The financial impact of the action (hold, freeze, or forfeiture)
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                The support contact for questions
              </p>
            </td>
            <td
              style={{
      ...
      >
        <li>
          Flag 1 — Warning: A user who believes the warning was issued in error
          or that the evidence does not support the violation finding.
        </li>
        <li>
        ...
        <li>
          ...
          miscalculated (e.g., due to expired flags being incorrectly counted).
        </li>
        <li>
      ...
      >
        ...
        <li>
          Step 2 — Navigate to Settings &gt; Support &gt; Appeal a Disciplinary
          Action.
        </li>
        <li>
        ...
        <li>
          ...
          confirmation that your appeal has been received, along with an appeal
          reference number.
        </li>
      </ul>
      <p
      ...
      >
        <em>
          ...
          from your registered email address to request an appeal form. Appeals
          from permanently banned users must still provide all information
          described in Section 37.
        </em>
      </p>
      <h2
      ...
      >
        An appeal that does not include sufficient information may be dismissed
        without review. Every appeal must include:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        <li>
          If you believe the flag count was incorrectly calculated — a specific
          explanation of which flags you believe have expired and when they were
          issued.
        </li>
      </ul>
      <p
      ...
      >
        <strong>
          ...
          appeal to be considered. Vague or unsupported appeals will be reviewed
          but are unlikely to result in a different outcome.
        </strong>
      </p>
      <h2
        style={{
      ...
      >
        The Company will review all appeals and communicate its decision within
        24 hours of the appeal being submitted. The review is conducted by a
        senior member of the trust and safety team who was not involved in the
      ...
      >
        The 24-hour timeline applies to the Company's decision — not necessarily
        the full resolution of any financial matters arising from the appeal
        outcome. Financial releases (e.g., prize money held during a suspension
        that is overturned) will be processed within the normal financial
        processing timelines after the appeal decision is communicated.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Any financial holds during suspension are released immediately.
                If the user was suspended as a result of the overturned flag,
                the suspension is lifted immediately.
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Appeal Upheld — Suspension Reduced
              </p>
            </td>
            <td
              style={{
            ...
            >
              ...
              >
                The suspension duration is reduced — for example, from 7 days to
                3 days — but the flag remains on the user's record.
              </p>
            </td>
            <td
              style={{
            ...
            >
              ...
              >
                Financial holds are released at the reduced suspension end date.
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Appeal Dismissed — Action Upheld
              </p>
            </td>
            <td
              style={{
      ...
      >
        If a user believes the appeal process itself was conducted improperly or
        unfairly, they may raise a formal grievance with the Company's Grievance
        Officer at{" "}
        <a href="mailto:legal@corpsearena.com" style={{ color: "var(--red)" }}>
          legal@corpsearena.com
        </a>
        . However, a grievance is not a second appeal — it is a review of the
        process, not the merits of the disciplinary decision.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        During a temporary suspension period, the following conduct is strictly
        prohibited:
      </p>
      <ul
        style={{
      ...
      >
        <li>
          Attempting to log in to the suspended account repeatedly — this may be
          treated as an attempt to circumvent the suspension and could result in
          an additional flag.
        </li>
        <li>
          ...
          transactions — during the suspension period. Using a secondary account
          during a suspension to evade the suspension will result in the
          secondary account being permanently banned and an additional flag
          being applied to the primary account.
        </li>
        <li>
          Harassing, abusing, or threatening the Company's support or trust and
          safety team members via any channel — in-app, email, or otherwise —
          during the suspension or appeal process. Such conduct will result in
          an additional flag.
        </li>
        <li>
      ...
      >
        <li>
          ...
          this will not accelerate the review and may result in the duplicate
          tickets being closed without review.
        </li>
        <li>
        ...
        <li>
          Threatening, pressuring, or attempting to influence the appeal outcome
          through inappropriate means — including threats of legal action
          communicated through support channels rather than formal legal
          processes.
        </li>
      </ul>
      <p
      ...
      >
        This Suspension Policy shall be governed by and construed in accordance
        ...
        2021, and all applicable provisions of the Indian Penal Code, as amended
        from time to time.
      </p>
      <h2
        style={{
      ...
      >
        ...
        including disputes about the application of flags, the conduct of appeal
        proceedings, or financial consequences of suspensions or bans — shall
        first be attempted to be resolved through the Platform's in-app appeal
        process as described in Part IX.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        If the appeal process is exhausted and the user wishes to raise a formal
        grievance about the process (not the merits), the grievance should be
        directed to the Grievance Officer at{" "}
        <a href="mailto:legal@corpsearena.com" style={{ color: "var(--red)" }}>
          legal@corpsearena.com
        </a>
        . If the grievance remains unresolved after 30 days, the dispute may be
        submitted to binding arbitration under the Arbitration and Conciliation
        Act, 1996. The seat of arbitration shall be Guwahati, Assam, India.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Within 24 hours of appeal submission
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
