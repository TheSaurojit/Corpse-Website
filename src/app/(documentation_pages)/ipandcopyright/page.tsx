...
export default function PolicyPage() {
  return (
    <DocShell
      ...
      subtitle="IP, Trademark & Copyright Policy protecting Corpse platform intellectual property."
    >
      <p
        style={{
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", background: "var(--g100)", border: "1px solid rgba(232,25,26,0.2)", fontSize: "14px" }}>
            <tbody>
              ...
              <tr style={{ borderBottom: "1px solid var(--g200)" }}>
                ...
                <td style={{ border: "1px solid var(--g200)", padding: "10px 14px", color: "var(--g600)", verticalAlign: "top" }}>
                  <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}><a href="mailto:ip@corpsearena.com" style={{ color: "var(--red)" }}>ip@corpsearena.com</a></p>
                </td>
              </tr>
              <tr style={{ borderBottom: "1px solid var(--g200)" }}>
                <td style={{ border: "1px solid var(--g200)", padding: "10px 14px", color: "var(--g600)", verticalAlign: "top" }}>
      ...
      >
        <em>
          All intellectual property, trademarks, and copyrighted works described
          in this document are the exclusive property of [CORPSE ESPORTS PRIVATE
          LIMITED]. Unauthorised use, reproduction, or infringement of any kind
          will be pursued to the fullest extent permitted under Indian law.
        </em>
      </p>
      <h2
        style={{
      ...
      >
        ...
        sole and exclusive owner of all intellectual property rights subsisting
        in and relating to the Corpse platform, its products, services,
        technology, content, branding, and associated works (collectively,
        "Corpse IP").
      </p>
      <p
        style={{
      ...
      >
        ...
        partners. All rights not expressly granted in writing by the Company are
        reserved.
      </p>
      <p
        style={{
      ...
      >
        ...
        or have access to Corpse IP, and the enforcement mechanisms available to
        the Company.
      </p>
      <p
        style={{
      ...
      >
        <strong>
          ...
          written agreement signed by a duly authorised director of the Company.
        </strong>
      </p>
      <h3
        style={{
      ...
      >
        ...
        intern, or contractor of the Company in the course of their employment,
        engagement, or contract — including but not limited to software code,
        design work, algorithms, documentation, marketing materials,
        architectural decisions, and any other creative or technical output —
        constitutes a "work made for hire" within the meaning of Section 17 of
      ...
      >
        <li>
          Whether the work was created during working hours or outside of them,
          provided it relates to the Company&apos;s business or platform.
        </li>
        <li>
      ...
      >
        ...
        disclose to the Company any IP created that relates to the Platform, its
        technology, or its business — whether or not they believe it falls
      ...
      >
        <em>
          ...
          Assignment Agreements with the Company. Those agreements are separate
          binding instruments that reinforce and supplement this Policy.
        </em>
      </p>
      <h3
        style={{
      ...
      >
        The intellectual property rights of the Company are protected under the
        following Indian statutes and, where applicable, international
          ...
          <tbody>
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  International copyright protection in all 181 member countries
      ...
      >
        ...
        intellectual property assets owned by [CORPSE ESPORTS PRIVATE LIMITED].
        This register is maintained by the Company and updated as new IP is
        created or registered. The absence of an asset from this register does
        not imply that it is not protected — all original works created by the
        Company are protected by copyright from the moment of creation under
      ...
      >
        ...
        been used in commerce, also enjoy common law protection as unregistered
        marks.
      </p>
      <div style={{ overflowX: "auto", marginBottom: "32px" }}>
        <table
          ...
          <tbody>
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  Trade Marks Act 1999 + Common Law
                </p>
              </td>
            </tr>
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  The words &apos;Corpse Arena&apos; as used in connection with
                  the tournament platform and competitive features
                </p>
              </td>
              <td
                style={{
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  ...
                  background, as used across all Company platforms and materials
                </p>
              </td>
              <td
                style={{
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  ...
                  used in Company communications, pitch materials, and platform
                  branding
                </p>
              </td>
              <td
      ...
      >
        The following works are owned by the Company as original works protected
        under Section 13 of the Copyright Act, 1957. Copyright subsists
        automatically from the date of creation and does not require
          ...
          <tbody>
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  ...
                  universal ELO-based skill scoring system for players, squads,
                  guilds, and organisers
                </p>
              </td>
              <td
                style={{
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  Archetype Analytics — source code
                </p>
              </td>
              <td
                style={{
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  All visual design elements, screen layouts, interface designs,
                  iconography, colour systems, typography choices, and user
                  experience flows of the Platform
                </p>
              </td>
              <td
                style={{
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  The original graphic design comprising the stylised lightning
                  bolt and bird silhouette on a red background, including all
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  The technical system documents, architecture decision records,
                  API documentation, and all engineering documentation authored
                  by the Company
                </p>
              </td>
              <td
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  All pitch decks, investor presentations, marketing collateral,
                  website copy, social media content, and promotional materials
      ...
      >
        <strong>
          Important: Copyright in software code extends to the literal code (the
          text of the program) and, in certain circumstances, to the non-literal
          elements such as structure, sequence, and organisation of the program.
          Anyone who copies, reproduces, or substantially reproduces the
          Platform&apos;s code — even after modification — may be liable for
      ...
      >
        ...
        the exclusive right to use the registered and common law marks listed in
        Section 4 in connection with the goods and services for which they are
        used. This includes:
      </p>
      <ul
        style={{
      ...
      >
        <li>
          ...
          in marketing, on merchandise, in communications, and in all commercial
          contexts.
        </li>
        <li>
          The right to prevent any third party from using an identical or
          deceptively similar mark in connection with identical or similar goods
          or services without the Company&apos;s consent.
        </li>
        <li>
          The right to bring an action for trademark infringement under Section
      ...
      >
        ...
        doctrine of passing off. This protection arises from the Company&apos;s
        use of the marks in commerce and the goodwill associated with them.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        To succeed in a passing off action, the Company would establish: (a) the
        existence of goodwill in the mark; (b) a misrepresentation by the
        defendant that causes confusion; and (c) damage or likely damage to the
        Company&apos;s goodwill. Given the Platform&apos;s commercial operations
        and user base, goodwill in the Corpse marks is established from the date
        of first use.
      </p>
      <p
        style={{
      ...
      >
        ...
        including the name CORPSE, CORPSE ARENA, the Corpse logo, or the tagline
        THE OPERATING SYSTEM FOR ESPORTS — in any of the following ways without
      ...
      >
        <strong>
          ...
          <a href="mailto:ip@corpsearena.com" style={{ color: "var(--red)" }}>
            ip@corpsearena.com
          </a>{" "}
          before use.
        </strong>
      ...
      >
        ...
        registered trademark if they use a mark that is identical or deceptively
        similar to the registered mark in the course of trade without consent,
        in relation to goods or services identical or similar to those for which
      ...
      >
        ...
        goods or services as being those of, or associated with, the Company in
        a way that damages or is likely to damage the Company&apos;s goodwill.
        Passing off does not require a registered trademark — it protects the
        Company&apos;s reputation and business goodwill directly.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        ...
        <li>
          Operating an esports platform, tournament service, or gaming community
          under a name that could be confused with Corpse or Corpse Arena.
        </li>
        <li>
          Registering domain names, social media handles, or app store listings
          that incorporate or imitate Corpse marks.
        </li>
        <li>
      ...
      >
        The Company will actively monitor and enforce its trademark rights. Upon
        becoming aware of any potential infringement or passing off, the Company
        may take the following steps, at its sole discretion:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        <li>
          Initiate civil proceedings seeking an injunction, damages, delivery up
          of infringing materials, and costs.
        </li>
        <li>
          File a criminal complaint under Section 103 of the Trade Marks Act,
          1999, which provides for imprisonment of up to three years and a fine
          for knowingly using a false trademark.
        </li>
        <li>
          Report infringing app store listings, social media accounts, or domain
          registrations to the relevant platform or registrar for takedown.
        </li>
      </ul>
      <h2
        style={{
      ...
      >
        ...
        <li>
          Artistic works — including the Corpse logo, all UI/UX design elements,
          visual interfaces, iconography, illustrations, and graphical assets.
        </li>
        <li>
      ...
      >
        ...
        perform it in public, communicate it to the public, make any translation
        or adaptation, and make any cinematograph film or sound recording in
        respect of it.
      </p>
      <h3
        style={{
      ...
      >
        ...
        artistic work as soon as it is created and expressed in a tangible form.
        No registration, notice, or deposit is required for copyright to exist
        and be enforceable in India.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        ...
        content produced is protected by copyright from the moment it comes into
        existence — regardless of whether it carries a copyright notice or has
      ...
      >
        <em>
          ...
          All Corpse works are protected from creation, whether or not a notice
          appears.
        </em>
      </p>
      <h3
      ...
      >
        While copyright subsists automatically without registration, the Company
        strongly recommends formal registration of key works with the Copyright
        Office of India (copyright.gov.in) before the Platform launches. This is
        a direct and honest recommendation, not a legal formality.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        ...
        <li>
          Enforcement leverage — registered copyrights are significantly easier
          and faster to enforce. Courts take registered claims more seriously
          and are more likely to grant urgent interim injunctions.
        </li>
        <li>
        ...
        <li>
          ...
          literary work, Rs 5,000 for software). The cost of not registering in
          a dispute is exponentially higher.
        </li>
        <li>
      ...
      >
        No person, entity, or organisation may perform any of the following acts
        in relation to any Corpse copyrighted work without the prior written
      ...
      >
        <li>
          Reproduce the work or any substantial part of it in any material form
          whatsoever — including copying source code, downloading design files,
          screenshotting proprietary interfaces, or replicating written content.
        </li>
        <li>
        ...
        <li>
          ...
          into any other form, including creating a modified version of the code
          or a redesigned version of the UI.
        </li>
        <li>
        ...
        <li>
          Create derivative works, modifications, forks, or ports of any Corpse
          software, design, or content.
        </li>
        <li>
      ...
      >
        By accepting the Platform&apos;s Terms and Conditions, users are granted
        a limited, non-exclusive, non-transferable, non-sublicensable, revocable
        licence to access and use the Platform and its features strictly for the
        personal, non-commercial purposes described in the Corpse Terms and
        Conditions.
      </p>
      <p
        style={{
      ...
      >
        <li>
          Any right to copy, reproduce, or store any part of the Platform&apos;s
          code, design, or content beyond what is strictly necessary for normal
          use of the Platform on a personal device.
        </li>
        <li>
          Any right to use Platform content — including match data, leaderboard
          data, ELO scores, or profile data — for any commercial purpose or
          external publication.
        </li>
        <li>
          Any right to sub-licence, assign, or transfer the licence to any third
          party.
        </li>
        <li>
      ...
      >
        ...
        The following are absolutely prohibited under this Policy and under the
        Platform&apos;s Terms and Conditions:
      </p>
      <ul
        style={{
      ...
      >
        <li>
          Creating any application, tool, website, or service that incorporates,
          replicates, or is derived from any Corpse copyrighted work.
        </li>
        <li>
        ...
        <li>
          Sub-licensing any Corpse content or software to any third party — the
          user&apos;s licence is personal and cannot be transferred or shared.
        </li>
        <li>
      ...
      >
        ...
        <li>
          You will immediately notify the Company at{" "}
          <a href="mailto:ip@corpsearena.com" style={{ color: "var(--red)" }}>
            ip@corpsearena.com
          </a>{" "}
          if you become aware of any infringement of Corpse IP by any third
          party.
        </li>
      </ul>
      <h3
      ...
      >
        ...
        tournaments are subject to the following additional IP obligations, over
        and above the general user obligations in Section 17:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          ...
          Platform remain the exclusive property of the Company. Organisers are
          granted a licence to use these tools for the purpose of running
          tournaments on the Platform — this licence does not transfer ownership
          of any tool, template, or interface.
        </li>
        <li>
        ...
        <li>
          ...
          through the Platform without the Company&apos;s prior written consent.
        </li>
        <li>
          Any branding, promotional materials, or tournament pages created using
          Corpse platform tools remain associated with the Company&apos;s
          platform and may not be repurposed as standalone branding outside the
          Platform.
        </li>
      </ul>
      <h3
      ...
      >
        This includes data contributed by users and organisers in the course of
        using the Platform. By using the Platform, users and organisers grant
        the Company a perpetual, irrevocable, worldwide, royalty-free licence to
        use, store, process, aggregate, analyse, and commercially exploit this
        data in any manner the Company sees fit, subject to the Platform&apos;s
        Privacy Policy.
      </p>
      <p
        style={{
      ...
      >
        ...
        <li>
          ...
          information removed) to research institutions, esports organisations,
          or commercial partners.
        </li>
        <li>
          Publish leaderboards, statistics, and rankings derived from Platform
          data as part of the Company&apos;s marketing and community engagement
          activities.
        </li>
      </ul>
      <p
      ...
      >
        <strong>
          ...
          Organisers may view and use this data within the Platform but may not
          export it for external commercial use.
        </strong>
      </p>
      <h3
        style={{
      ...
      >
        ...
        <li>
          ...
          licence to use, reproduce, display, adapt, and distribute that content
          for the purpose of operating and promoting the Platform.
        </li>
        <li>
          The user represents and warrants that any content they submit does not
      ...
      >
        The Company intends to make certain Platform APIs available to approved
        third-party developers and organisations ("API Partners") to enable
        integration with the Platform&apos;s data and features. Any such API
        access is granted exclusively on the following terms:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          ...
          non-transferable licence to interact with specified Platform endpoints
          for the permitted purposes set out in a separate API Licence
          Agreement.
        </li>
        <li>
          The licence is personal to the API Partner — it cannot be assigned,
          sub-licensed, or transferred to any other person or entity without the
          Company&apos;s prior written consent.
        </li>
        <li>
          The licence is strictly limited to the scope of permitted use defined
          in the API Licence Agreement. Any use beyond that scope is unlicensed
          and constitutes a breach of this Policy and the API Licence Agreement.
        </li>
        <li>
          The licence may be revoked by the Company at any time, with or without
          cause, upon written notice to the API Partner.
        </li>
      </ul>
      <h3
        style={{
      ...
      >
        ...
        described in Section 21. In particular, API access does not grant any of
        the following:
      </p>
      <ul
        style={{
      ...
      >
        <li>
          Any ownership interest, co-ownership, or equity interest in any Corpse
          IP — including the underlying code, algorithms, data models, or
          architecture.
        </li>
        <li>
        ...
        <li>
          ...
          retrieved via the API beyond the specific permitted use defined in the
          API Licence Agreement.
        </li>
        <li>
          Any right to sub-licence the API access or data obtained through it to
          any third party.
        </li>
        <li>
      ...
      >
        ...
        <li>
          Using API-obtained data to train, fine-tune, or improve any artificial
          intelligence or machine learning model without the Company&apos;s
        ...
        <li>
          Using API access to circumvent any access restriction, rate limit, or
          data protection measure implemented by the Company.
        </li>
      </ul>
      <h3
        style={{
      ...
      >
        ...
        establishes the IP framework governing all API access — the API Licence
        Agreement governs the specific technical, commercial, and operational
        terms of each individual integration.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        To apply for API access, contact{" "}
        <a href="mailto:ip@corpsearena.com" style={{ color: "var(--red)" }}>
          ip@corpsearena.com
        </a>{" "}
        with a description of the intended use case and the organisation&apos;s
        details.
      </p>
      <h3
        style={{
      ...
      >
        ...
        revocation, the API Partner&apos;s voluntary cessation, or expiry of the
        API Licence Agreement — the following obligations apply immediately:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        By virtue of their employment contract or contractor agreement with the
        Company, every employee, director, and contractor automatically assigns
        to the Company, with full title guarantee, all intellectual property
        rights (including copyright, design rights, and any other rights) in all
        works, inventions, improvements, and developments they create, conceive,
      ...
      >
        ...
        <li>Using the Company&apos;s resources, information, or equipment.</li>
        <li>
      ...
      >
        ...
        <li>
          All written content, documentation, technical specifications, business
          plans, pitch materials, and marketing content created by the employee
          or contractor.
        </li>
        <li>
        ...
        <li>
          All work product created during any trial period, probationary period,
          or internship.
        </li>
      </ul>
      <p
      ...
      >
        ...
        and must include a description of the work created, the date of
        creation, and the circumstances of its creation. Failure to disclose IP
        is a breach of the employment or contractor agreement and may result in
      ...
      >
        All IP assignment obligations under this Part survive the termination of
        employment or engagement for any reason — resignation, redundancy,
      ...
      >
        <li>
          All Company IP in the employee&apos;s or contractor&apos;s possession
          — including source code repositories, design files, documentation, and
          any copies thereof — must be returned to the Company or securely
          deleted within 7 days of the termination date.
        </li>
        <li>
        ...
        <li>
          ...
          against any former employee or contractor who misuses Corpse IP after
          termination.
        </li>
      </ul>
      <h2
      ...
      >
        <li>
          Does anything that only the owner has the exclusive right to do — such
          as reproducing, distributing, or communicating the work to the public.
        </li>
        <li>
          Permits any place to be used for the communication of the work to the
          public for profit, where such communication constitutes an
          infringement of copyright.
        </li>
        <li>
          Imports infringing copies of the work into India for sale or hire, or
          by way of trade offers or exposes for sale or hire any infringing
          copy.
        </li>
      </ul>
      <p
      ...
      >
        ...
        <li>
          Creating a competing application, platform, or tool that substantially
          reproduces the design, layout, or functional architecture of the
          Platform.
        </li>
        <li>
          Scraping, downloading, or redistribution of Platform content, data, or
          design elements without authorisation.
        </li>
        <li>
      ...
      >
        Under Section 29 of the Trade Marks Act, 1999, a registered trademark is
        infringed when a person uses in the course of trade a mark which is:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        <li>
          Identical to the registered trademark in relation to similar goods or
          services, and there is a likelihood of confusion.
        </li>
        <li>
      ...
      >
        ...
        additionally protected against passing off at common law — any use of a
        confusingly similar mark that damages the Company&apos;s goodwill is
      ...
      >
        ...
        <li>
          Damages — compensation for the actual loss suffered by the Company as
          a result of the infringement, including loss of revenue, market share,
          and reputational damage.
        </li>
        <li>
          Account of profits — an order requiring the infringer to disgorge all
          profits made from the infringing activity, as an alternative to
          damages.
        </li>
        <li>
          Delivery up and destruction — an order requiring the infringer to
          deliver up all infringing copies, materials, and equipment used in the
          infringement, for destruction or forfeiture.
        </li>
        <li>
      ...
      >
        Copyright and trademark infringement are criminal offences under Indian
        law, in addition to being civil wrongs:
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        ...
        copyright in a work shall be punishable with imprisonment for a term of
        not less than six months, which may extend to three years, and a fine of
        not less than Rs 50,000, which may extend to Rs 2,00,000. For second and
        subsequent offences, the imprisonment term shall not be less than one
        year.
      </p>
      <p
        style={{
      ...
      >
        ...
        possesses articles for labelling goods with a false trademark, shall be
        punishable with imprisonment for a term of not less than six months,
        which may extend to three years, and a fine of not less than Rs 50,000,
      ...
      >
        ...
        infringers in addition to or instead of civil proceedings, based on the
          ...
          <tbody>
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  <a
                    href="mailto:ip@corpsearena.com"
                    style={{ color: "var(--red)" }}
                  >
                    ip@corpsearena.com
                  </a>
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              >
                ...
                >
                  ...
                  where infringement was observed, the date first observed, and
      ...
      >
        ...
        infringing a third party&apos;s rights, contact{" "}
        <a href="mailto:ip@corpsearena.com" style={{ color: "var(--red)" }}>
          ip@corpsearena.com
        </a>
      ...
      >
        ...
        the Copyright Act, 1957, the Trade Marks Act, 1999, and the Information
      ...
      >
        ...
        contractual parties — including employees, contractors, and API partners
        — the parties agree to first attempt resolution through good faith
        negotiation. If unresolved within 30 days, the dispute shall be
        submitted to binding arbitration under the Arbitration and Conciliation
        Act, 1996. The seat of arbitration shall be Guwahati, Assam, India. The
      ...
      >
        Nothing in this Policy prevents the Company from seeking urgent interim
        or interlocutory relief from a court of competent jurisdiction at any
        time, without prior recourse to arbitration.
      </p>
      <h3
        style={{
          fontFamily: "var(--font-ui)",
      ...
      >
        <em>
          ...
          of any Corpse IP will be pursued to the fullest extent of Indian law.
        </em>
      </p>
    </DocShell>
  );
