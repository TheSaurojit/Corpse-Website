...
export default function PolicyPage() {
  return (
    <DocShell
      title="Arena Terms"
      badge="Legal · Arena"
      subtitle="Arena Joining Terms & Conditions governing tournament participation on the Corpse platform."
    >
      <p
        style={{
      ...
      {/* <div style={{ overflowX: "auto", marginBottom: "32px" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", background: "var(--g100)", border: "1px solid rgba(232,25,26,0.2)", fontSize: "14px" }}>
            ...
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              ...
              <td style={{ border: "1px solid var(--g200)", padding: "10px 14px", color: "var(--g600)", verticalAlign: "top" }}>
                <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>Free Fire (Garena Free Fire MAX)</p>
              </td>
            </tr>
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              <td style={{ border: "1px solid var(--g200)", padding: "10px 14px", color: "var(--g600)", verticalAlign: "top" }}>
              ...
              <td style={{ border: "1px solid var(--g200)", padding: "10px 14px", color: "var(--g600)", verticalAlign: "top" }}>
                <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>Garena Online Private Limited</p>
              </td>
            </tr>
            <tr style={{ borderBottom: "1px solid var(--g200)" }}>
              <td style={{ border: "1px solid var(--g200)", padding: "10px 14px", color: "var(--g600)", verticalAlign: "top" }}>
      ...
      {/* <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
        ...
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 1. What the Arena Is</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 2. Scope — Free &amp; Paid Arenas</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 3. Launch Game — Free Fire</p>
        ...
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 5. Free Arenas</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 6. Paid Arenas</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 7. Free Fire Game Modes Supported</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 8. Squad Formats &amp; Preset Structure</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 9. Map &amp; Room Configuration</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART III Player Eligibility</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 10. Account Requirements</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 11. Age &amp; KYC Requirements</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 12. In-Game ID Requirement</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 13. ELO-Based Matchmaking</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 14. Ineligible Players</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART IV Arena Timeline</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 15. The Five Stages of Every Arena</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 16. Registration Open &amp; Close</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          {" "}
          17. Room Card Availability — 30 Minutes Before Start
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 18. Match Start</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 19. Result Submission Window</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART V Squad Formation &amp; Registration</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 20. Squad Creation by Captain</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 21. Invite Token System</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          {" "}
          22. Multiple Arena Registration — Time Conflict Rule
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 23. Registration Lock — No Withdrawal</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 24. Entry Fee — Non-Refundable on Registration</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 25. Duplicate Registration Prevention</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 26. Organiser Cannot Remove Registered Players</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART VI In-Game Identity &amp; Device Rules</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 27. Mandatory In-Game ID Verification</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 28. Emulator Ban — Mobile Only</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 29. Free Fire Account Status</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART VII Room Card &amp; Match Start</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 30. How the Room Card Is Generated &amp; Shared</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 31. Room Card Confidentiality</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 32. Joining the Game Room</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 33. Partial Squad — Missing Member</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 34. No Delays After Match Start</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
        ...
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 36. Prohibited In-Game Software &amp; Tools</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 37. Match Fixing &amp; Result Manipulation</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 38. Room Card Sharing During Match</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 39. Player Conduct &amp; Sportsmanship</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 40. Garena Account Actions During Match</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART IX Result Submission Process</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 41. The Auto-Capture System</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 42. Step-by-Step — Player Result Submission</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 43. Step-by-Step — Organiser Result Submission</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 44. The 60-Second Upload Window</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 45. Manual Upload Option</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 46. Result Verification by Corpse</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART X Result Disputes</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 47. Right to Dispute</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 48. Dispute Submission Process</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 49. Evidence Requirements</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 50. Corpse's Review &amp; Decision</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 51. Outcomes of a Dispute</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 52. Frivolous Disputes</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART XI Disqualification</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 53. Grounds for Disqualification</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 54. Consequences of Disqualification</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 55. Winner Ladder on Disqualification</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART XII Platform Liability</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 56. Game Server &amp; Publisher Issues</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 57. Player Device &amp; Connectivity Issues</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 58. Arena Cancelled by Corpse</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 59. Organiser Failure to Share Room Card</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>PART XIII Prohibited Conduct — Full Reference</strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 60. Complete List of Prohibited Acts</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}>
          <strong>
            PART XIV Governing Law, Dispute Resolution &amp; Contact
          </strong>
        </p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 61. Governing Law</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 62. Dispute Resolution</p>
        <p style={{ fontFamily: "var(--font-sub)", fontSize: "15px", lineHeight: 1.75, color: "var(--g600)", marginBottom: "20px" }}> 63. Contact</p> */}
      <p
        style={{
          fontFamily: "var(--font-sub)",
          fontSize: "15px",
      ...
      >
        ...
        platform — a structured, organised, and verified competitive space where
        players form squads, register for matches, compete against other squads,
        and earn prizes. Unlike informal tournaments organised through WhatsApp
        groups or Discord servers, every Arena on the Corpse platform operates
        within a defined framework of rules, timelines, verified identities, and
        transparent results.
      </p>
      <p
        style={{
      ...
      >
        ...
        infrastructure — registration, squad management, room card distribution,
        result submission, and prize disbursement — while the Organiser
        configures the specific parameters of each Arena within the options
        provided by their selected preset.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
      ...
      >
        The financial rules — entry fee payment, prize disbursement, and refund
        policies — apply only to paid arenas and are governed in detail by the
        Money Deposit &amp; Receive Policy. These Arena T&amp;C reference those
        rules where relevant but do not repeat them in full.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
      ...
      >
        At launch, the Corpse platform supports competitive arenas for one game
        title: Free Fire (Garena Free Fire MAX), published by Garena Online
        Private Limited (&quot;Garena&quot;). All Arena rules, match formats,
        squad sizes, and conduct standards described in these Arena T&amp;C are
        designed specifically for Free Fire gameplay.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        As the Platform expands to support additional game titles in the future,
        separate or supplementary Arena T&amp;C will be published for each new
        title. These terms govern only Free Fire arenas until further notice.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        <em>
          ...
          affiliated with, endorsed by, or officially partnered with Garena. Use
          of Free Fire's game infrastructure — including custom rooms — is
          conducted in accordance with Garena's terms of service for custom room
          creation.
        </em>
      </p>
      <h2
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Flag system, warnings, suspensions, and bans triggered by Arena
                conduct violations
              </p>
            </td>
          </tr>
      ...
      >
        ...
        <li>
          Do not involve any financial transaction — no entry fee is paid and no
          prize money is disbursed.
        </li>
        <li>
        ...
        <li>
          Contribute to the Platform's ELO ranking system — performance in free
          arenas affects a player's ELO score equally to paid arenas.
        </li>
        <li>
          May have a prize in the form of in-app recognition, badges, or credits
          — but no monetary prize pool unless the Organiser has specifically
          configured a non-cash prize under the applicable preset.
        </li>
      </ul>
      <h2
        style={{
      ...
      >
        Paid arenas are competitive matches on the Platform where players pay an
        entry fee to participate and compete for a monetary prize pool funded by
        the Organiser's security deposit. Paid arenas:
      </p>
      <ul
        style={{
          listStyle: "disc",
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                The classic Free Fire survival format — squads compete to be the
                last team standing on the map. Players are eliminated when their
                health reaches zero and cannot be revived after final
                elimination.
              </p>
            </td>
            <td
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                ...
                opposing team. The first team to win a set number of rounds wins
                the match.
              </p>
            </td>
            <td
      ...
      >
        The squad format — including the number of players per squad, the number
        of squads per arena, and the entry fee amount — is determined by the
        Organiser's selected preset. Organisers choose from a set of approved
        presets provided by the Platform. The following squad formats are
        supported across Free Fire arenas:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          Solo — 1 player per squad. Each participant registers individually as
          both Captain and sole squad member.
        </li>
        <li>
        ...
        <li>
          Squad — 4 players per squad. Captain registers and invites three squad
          members for Battle Royale formats.
        </li>
        <li>
          Clash Squad — 4 players per team (4v4). Each team of 4 registers as a
          squad.
        </li>
      </ul>
      <p
      ...
      >
        ...
        listing page before registration. Players must ensure they register for
        an Arena with a format that matches their squad size. The Platform
      ...
      >
        The Free Fire map and custom room settings for each Arena are configured
        by the Organiser within the options provided by their selected preset.
        This may include:
      </p>
      <ul
        style={{
      ...
      >
        <li>
          ...
          determined by the Organiser's preset selection, not randomly assigned
          by Free Fire.
        </li>
        <li>
        ...
        <li>
          The Organiser creates the custom room directly within Free Fire using
          Free Fire's custom room feature and shares the resulting room ID and
          password with registered players via the Platform's room card system.
        </li>
      </ul>
      <p
        style={{
      ...
      >
        <li>
          Be a Registered User with an active, verified account on the Platform.
          Guest Users cannot register for or participate in any Arena.
        </li>
        <li>
        ...
        <li>
          ...
          their Platform account. Players without a registered in-game ID cannot
          join any Free Fire arena.
        </li>
        <li>
          Have agreed to these Arena T&amp;C, the Corpse Terms &amp; Conditions,
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Yes — KYC required and must be complete before paying entry fee
              </p>
            </td>
            <td
              style={{
            ...
            >
              ...
              >
                Yes — no KYC required as squad member
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                No — cannot be Captain of any Arena
              </p>
            </td>
            <td
              style={{
            ...
            >
              ...
              >
                Yes — if invited by KYC-verified Captain
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
      ...
      >
        ...
        <li>
          ...
          — the player must enter the game room using this specific Free Fire
          account.
        </li>
        <li>
          Cannot be changed or updated during an active Arena registration. Any
          in-game ID update request during an active registration period will
          not take effect until after the Arena concludes.
        </li>
      </ul>
      <p
        style={{
      ...
      >
        The Platform uses its proprietary ELO ranking system to group players of
        similar competitive skill levels within arenas. This means:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        <li>
          When players register for an Arena, the Platform's matchmaking system
          groups squads with similar ELO scores into the same arena — ensuring
        ...
        <li>
          All ranks are welcome on the Platform — there is no minimum Free Fire
          rank requirement. The ELO system ensures fair competition regardless
          of in-game rank.
        </li>
        <li>
      ...
      >
        Every Arena on the Platform progresses through five defined stages. The
        timing of each stage is set by the Organiser when creating the Arena and
        is displayed on the Arena listing page before registration opens.
        Players must be aware of and adhere to all stage timelines.
      </p>
      <div style={{ overflowX: "auto", marginBottom: "32px" }}>
        <table
          style={{
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                The Arena is published and open for squad registration. Players
                can discover, view details, and register during this stage.
              </p>
            </td>
            <td
              style={{
            ...
            >
              ...
              >
                Captain registers squad and pays entry fee (paid arenas). Squad
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                ...
                locked. No new registrations, squad changes, or withdrawals are
            ...
            >
              ...
              >
                No action — preparation for match only.
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                The scheduled match start time. The Free Fire custom room match
                begins. Players must be inside the game room by this time.
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Capture and submit match result screenshot within the 60-second
                upload window after Organiser submission.
              </p>
            </td>
          </tr>
          </tbody>
      ...
      >
        The registration open and close times are set entirely by the Organiser
        when creating the Arena. The Platform enforces these timelines
        technically — registrations submitted after the registration close time
        are automatically rejected regardless of slot availability.
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          The registration open and close times are displayed prominently on the
          Arena listing page. Players are responsible for checking these times
      ...
      >
        ...
        minutes before the scheduled match start time. This timing is fixed by
        the Platform and applies to all Arenas regardless of the Organiser's
        preferences.
      </p>
      <ul
        style={{
      ...
      >
        <li>
          All registered players — both Captains and squad members — receive the
          room card notification simultaneously.
        </li>
        <li>
          The notification is delivered within the Corpse app. Players must
          ensure in-app notifications are enabled on their device to receive the
          room card on time.
        </li>
        <li>
          ...
          notifications, device issues, or network connectivity problems on the
          player's end.
        </li>
      </ul>
      <p
      ...
      >
        <em>
          ...
          immediately via in-app support. Do not wait until match start time to
          report a missing room card.
        </em>
      </p>
      <h2
        style={{
      ...
      >
        ...
        <li>
          Any squad that is not inside the room when the match starts will miss
          the match — the match does not wait for absent players or squads.
        </li>
      </ul>
      <h2
        style={{
      ...
      >
        After the match concludes, all players and the Organiser are required to
        submit their match result screenshots through the Platform's
      ...
      >
        Every squad on the Platform is created and led by a Captain. The Captain
        is the registered user who initiates the squad, pays the entry fee (for
        paid arenas), manages squad invitations, and receives the squad's prize
        money on behalf of all squad members.
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          Any eligible Registered User can create a squad and become Captain of
          that squad for a specific Arena.
        </li>
        <li>
        ...
        <li>
          The Captain is responsible for ensuring all squad members they invite
          are aware of and agree to these Arena T&amp;C.
        </li>
        <li>
      ...
      >
        <strong>
          ...
          representative of your squad. All prize money is disbursed exclusively
          to your KYC-verified bank account. Distribution of prize money to your
          squad members is your sole responsibility. The Platform has no
          involvement in or liability for internal squad prize distribution.
        </strong>
      </p>
      <h2
        style={{
      ...
      >
        The Captain invites squad members to join the squad using the Platform's
        invite token system. Each invite is a single-use, time-limited token
        that allows exactly one player to join the squad.
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          The Captain generates an invite link from within the squad management
          screen.
        </li>
        <li>
        ...
        <li>
          ...
          clicks the link and joins the squad, the token is permanently consumed
          and cannot be reused.
        </li>
        <li>
          Invite tokens carry an expiry timestamp — expired tokens are rejected
          regardless of whether the squad has available slots.
        </li>
        <li>
      ...
      >
        <em>
          Note: Squad members must accept their invites before the registration
          closes. Invites that are not accepted before the registration close
          time are automatically invalidated — the Captain must ensure all squad
          members join before the deadline.
        </em>
      </p>
      <h2
        style={{
      ...
      >
        A player may register for more than one Arena at a time, subject to the
        following strict time conflict rule:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        <li>
          ...
          Platform will not process refund claims based on scheduling conflicts
          that arise from the player's own multiple registrations.
        </li>
      </ul>
      <p
        style={{
      ...
      >
        ...
        <li>
          The Organiser cannot remove a registered squad or player from an Arena
      ...
      >
        <strong>
          ...
          Ensure your squad is complete, all members are available for the match
          time, and your in-game details are correct before completing
      ...
      >
        <li>
          ...
          personal scheduling conflicts, illness, device issues, or connectivity
          problems.
        </li>
        <li>
        ...
        <li>The squad's poor performance or early elimination in the match.</li>
        <li>
      ...
      >
        The only circumstances in which entry fees are refunded are governed by
        the Money Deposit &amp; Receive Policy — specifically, if the Arena is
        cancelled before the match starts. See the Money Deposit &amp; Receive
        Policy for the full refund framework.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
      ...
      >
        <li>
          A player cannot register for the same Arena twice — whether as Captain
          of two different squads or as a member of two different squads in the
          same Arena.
        </li>
        <li>A squad cannot be registered for the same Arena more than once.</li>
        <li>
          These checks are enforced at the database level using row-level
          locking — ensuring that even simultaneous registration attempts by the
          same user cannot result in duplicate registrations.
        </li>
      </ul>
      <h2
        style={{
      ...
      >
        Once a squad has been registered for an Arena and the slot is confirmed,
        the Organiser does not have the ability to remove the squad or any
        individual player from the Arena. Registration is final for all parties
        — including the Organiser. This protection exists to:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        . Only the Platform has the authority to disqualify or remove a player
        from an Arena after registration.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
      ...
      >
        <li>
          The in-game ID registered on the player's Corpse account exists and is
          a valid, active Free Fire account.
        </li>
        <li>
      ...
      >
        ...
        Arena match. The in-game name visible in the Free Fire custom room must
        match the in-game name registered on the player's Corpse account.
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        <li>
          ...
          registration on Corpse — the player must update their in-game name on
          their Corpse profile before the Arena begins. Failure to do so may
      ...
      >
        ...
        <li>
          ...
          emulator users within the game. Detection by Garena's systems during a
          Corpse Arena will result in disqualification from the Arena and may
          trigger a flag under the Account Suspension &amp; Ban Policy.
        </li>
        <li>
      ...
      >
        ...
        Garena. Players are responsible for ensuring their own Free Fire account
        is in a condition that allows them to join and play in a custom room at
        the time of the Arena.
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        Card&quot;). The Organiser then enters the Room Card into the Platform's
        organiser dashboard, which distributes it to all registered players via
        in-app notification.
      </p>
      <ul
        style={{
      ...
      >
        <li>
          The Room Card is distributed to all registered players — both Captains
          and squad members — simultaneously via in-app push notification.
        </li>
        <li>
          Room Card distribution occurs exactly 30 minutes before the scheduled
          match start time.
        </li>
        <li>
      ...
      >
        <li>
          ...
          intentionally or carelessly — is a serious violation that will result
          in immediate disqualification of the offending player's entire squad.
        </li>
        <li>
          If non-registered players join the custom room using a leaked Room
          Card and participate in the match, the Arena may be invalidated at the
          Platform's sole discretion. Registered players who were unaware of the
          leak will not be penalised, but the Organiser will be investigated.
        </li>
        <li>
          ...
          via in-app support before the match starts. The Platform will work
          with the Organiser to generate a new custom room if time permits.
        </li>
      </ul>
      <p
        style={{
      ...
      >
        <strong>
          ...
          violation and will result in disqualification of the responsible squad
          and a flag under the Account Suspension &amp; Ban Policy. In severe
          cases involving deliberate infiltration of matches by
      ...
      >
        ...
        <li>Enter the Room ID and Password from the Room Card notification.</li>
        <li>
      ...
      >
        <li>
          The squad is not disqualified due to one or more members being absent
          from the room at match start.
        </li>
        <li>
        ...
        <li>
          The absence of a squad member does not entitle any player to a refund
          of entry fees — the squad's registration and entry fee remain locked
          regardless of absent members.
        </li>
      </ul>
      <p
        style={{
      ...
      >
        <em>
          ...
          disadvantages the squad. The Platform strongly recommends ensuring all
          squad members are available and ready before the match start time. If
          a member is unavailable — inform the Captain well in advance so the
          Captain can attempt to organise a replacement before registration
          closes.
        </em>
      </p>
      <h2
      ...
      >
        ...
        and the Organiser is instructed to start the match at the scheduled time
        regardless of absent squads or players.
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          ...
          the match. There is no mechanism for late entry into an ongoing match.
        </li>
        <li>
        ...
        <li>
          The match will proceed even if some registered squads are absent — the
          Platform does not require 100% squad attendance to allow the match to
          start.
        </li>
      </ul>
      <p
      ...
      >
        ...
        <li>
          ...
          Community Guidelines for Free Fire. Violations are enforced by Garena
          directly through their own game moderation and account management
          systems.
        </li>
      </ul>
      <p
      ...
      >
        ...
        Arena match. A violation of Garena's rules does not exempt a player from
        Corpse's rules, and vice versa. Garena's enforcement of their own rules
        — including in-game bans, temporary account restrictions, or match
        penalties — does not affect Corpse's independent application of these
        Arena T&amp;C.
      </p>
      <h2
        style={{
      ...
      >
        The following software, tools, and modifications are strictly prohibited
        during any Corpse Arena match:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          Aimbots — any software that automatically assists with targeting, aim,
          or accuracy in Free Fire.
        </li>
        <li>
          Wallhacks or ESP (Extra Sensory Perception) software — tools that
          allow players to see through walls, detect enemy positions, or access
          information not available through normal gameplay.
        </li>
        <li>
          Speed hacks — software that artificially increases a player's movement
          speed, action speed, or reload speed beyond normal Free Fire gameplay
          parameters.
        </li>
        <li>
        ...
        <li>
          Damage modification — software that artificially increases the damage
          dealt by weapons or reduces damage received.
        </li>
        <li>
          Auto-fire or trigger bots — software that automatically fires weapons
          when an enemy is in the crosshair.
        </li>
        <li>
      ...
      >
        ...
        financial gain or competitive advantage — is the most serious violation
        that can occur within a Corpse Arena. The following constitute match
        fixing:
      </p>
      <ul
        style={{
      ...
      >
        <li>
          Pre-arranging match results with opposing squads — agreeing before the
          match who will win or lose.
        </li>
        <li>
        ...
        <li>
          Coordinating with the Organiser to manipulate results — colluding with
          the Organiser to ensure a specific outcome regardless of actual match
          performance.
        </li>
        <li>
          Score manipulation — artificially inflating kills, damage, or survival
          time through coordination with other players.
        </li>
        <li>
          Any arrangement — formal or informal — designed to ensure prize money
          goes to a pre-determined recipient regardless of match performance.
        </li>
      </ul>
      <p
        style={{
      ...
      >
        Sharing the Room Card during an ongoing match — for example, to allow a
        non-registered player to spectate or participate — is prohibited. Even
        if the intent is not malicious, allowing non-registered individuals into
        the custom room compromises match integrity and will result in
        disqualification of the responsible squad.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
      ...
      >
        ...
        respect throughout the Arena — before, during, and after the match. The
      ...
      >
        ...
        <li>
          Intentional disconnection — deliberately disconnecting from the match
          to disrupt the Arena or gain a restart advantage.
        </li>
        <li>
      ...
      >
        <li>
          Corpse is not responsible for Garena's enforcement actions and cannot
          override or reverse Garena's decisions.
        </li>
        <li>
        ...
        <li>
          ...
          Platform's discretion. If the Arena cannot be rescheduled, entry fees
          will be refunded per the Money Deposit &amp; Receive Policy.
        </li>
      </ul>
      <p
        style={{
      ...
      >
        ...
        eliminating the need for players to manually take screenshots and upload
        them separately. This system is called the Auto-Capture System.
      </p>
      <p
        style={{
          fontFamily: "var(--font-sub)",
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Tap 'Start Match' in the Corpse app
              </p>
            </td>
            <td
              style={{
            ...
            >
              ...
              >
                Before entering the Free Fire custom room, the Captain taps the
                'Start Match' button in the Corpse app to signal that the match
                is beginning. This activates the Auto-Capture System.
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                ...
                floating widget. This button remains accessible while the player
                switches to the Free Fire app.
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                The player enters the Free Fire custom room and plays the match
                as normal. The floating capture button remains visible as an
                overlay throughout the match.
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Tap the floating capture button
              </p>
            </td>
            <td
              style={{
            ...
            >
              ...
              >
                ...
                current screen (the scoreboard) and automatically queues it for
                upload.
              </p>
            </td>
          </tr>
      ...
      >
        <em>
          Note: The floating capture button must be tapped while the scoreboard
          is visible on screen. If the player navigates away from the scoreboard
          before tapping the capture button — the auto-capture may not correctly
          capture the result data. Ensure the full scoreboard is visible before
          tapping capture.
        </em>
      </p>
      <h2
      ...
      >
        <li>
          The Organiser is present in the Free Fire custom room as the room host
          throughout the match.
        </li>
        <li>
          When the match ends and the scoreboard is visible, the Organiser taps
          the floating capture button in the Corpse organiser app.
        </li>
        <li>
          The Organiser's screenshot — which includes the full match scoreboard
          with all squad rankings, kill counts, and other match statistics — is
      ...
      >
        <strong>
          Important: The moment the Organiser successfully uploads their result
          screenshot, the 60-second player upload window begins. All players who
          have not yet uploaded their screenshot must do so within 60 seconds of
          the Organiser's submission. This is a firm, system-enforced deadline.
        </strong>
      </p>
      <h2
        style={{
      ...
      >
        ...
        <li>
          Players who have not yet submitted their screenshot when the countdown
          begins must do so within 60 seconds.
        </li>
        <li>
      ...
      >
        <strong>
          Important: 60 seconds is a very short window. Players must be ready to
          tap the capture button and upload as soon as the match ends. Do not
          leave the scoreboard screen, navigate away from the app, or delay
          after the match ends. If you miss the window, your personal screenshot
          data will not be considered in result verification.
        </strong>
      </p>
      <h2
        style={{
      ...
      >
        ...
        <li>
          The manual upload is subject to the same 60-second window — it must be
          completed before the window closes.
        </li>
      </ul>
      <p
        style={{
      ...
      >
        <em>
          ...
          process than auto-captures. Ensure your screenshot is clear, unedited,
          and shows the complete scoreboard. Edited, cropped, or unclear
          screenshots will be rejected during result verification.
        </em>
      </p>
      <h2
        style={{
      ...
      >
        ...
        cannot be changed except through the formal dispute process described in
        Part X.
      </p>
      <p
        style={{
      ...
      >
        ...
        dispute the verified match result if they believe it is incorrect — for
        example, if the wrong squad is declared the winner, if kill counts are
        inaccurate, or if the result does not reflect the actual match outcome.
        The right to dispute is available for 24 hours after the match result is
        officially posted on the Platform.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
      ...
      >
        ...
        <li>
          Step 2 — Select the specific aspect of the result being disputed — for
          example, incorrect winner, incorrect kill count, or incorrect squad
          ranking.
        </li>
        <li>
      ...
      >
        ...
        officially posted. Disputes submitted after this window are not accepted
        under any circumstance — plan accordingly.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
      ...
      >
        <li>
          A clear, unedited screenshot of the match scoreboard showing the full
          match results — including all squad rankings, kill counts, and
          survival times.
        </li>
        <li>
        ...
        <li>
          ...
          screen recordings, or evidence supporting the claim must be provided.
        </li>
        <li>
      ...
      >
        <strong>
          Important: Submitting false or manipulated screenshots as evidence in
          a dispute is a serious violation that will result in immediate
          disqualification, a flag, and potential permanent ban. The Platform's
          result verification team is experienced in identifying edited or
      ...
      >
        The Platform's result verification team reviews every submitted dispute
        and provides a final decision within 24 hours of the dispute being
        submitted. The review process involves:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          Comparing the dispute evidence with the original Organiser submission
          and all player submissions from the match.
        </li>
        <li>
      ...
      >
        The Platform's dispute decision is communicated to the disputing player
        via in-app notification and email within the 24-hour review window.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                The Platform finds a specific element of the result is incorrect
                — such as kill count — but the overall winner determination
                remains unchanged.
              </p>
            </td>
            <td
            ...
            >
              ...
              >
                No change to prize disbursement if overall winner is unchanged.
                ELO scores may be adjusted.
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
      ...
      >
        ...
        evidence, is based on subjective dissatisfaction with the match outcome
        rather than an objective error, or is submitted repeatedly for the same
        result after a decision has been made. Frivolous disputes:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        <li>
          May be dismissed without full review if the platform's team determines
          within initial review that no credible basis exists for the dispute.
        </li>
        <li>
          May result in a flag under the Account Suspension &amp; Ban Policy if
          the player engages in a pattern of frivolous dispute submissions.
        </li>
        <li>
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Player uses prohibited software, tools, or modifications during
                the match.
              </p>
            </td>
            <td
            ...
            >
              ...
              >
                The individual player and their squad.
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Player allows another person to play on their behalf using their
                Free Fire account.
              </p>
            </td>
            <td
      ...
      >
        ...
        <li>
          The disqualified player(s) receive a flag under the Account Suspension
          &amp; Ban Policy — the specific flag consequence (warning, suspension,
          or ban) depends on the player's current active flag count.
        </li>
        <li>
          The disqualification is recorded on the Platform's disciplinary record
          for the player.
        </li>
        <li>
      ...
      >
        <li>
          If the 1st place squad is disqualified — the 2nd place squad moves to
          1st place and receives the 1st place prize. The 3rd place squad moves
          to 2nd place, and so on.
        </li>
        <li>
          The prize amounts remain the same — the prize associated with each
          position is awarded to the squad now occupying that position after the
          ladder shift.
        </li>
        <li>
      ...
      >
        The Platform operates as an independent tournament infrastructure layer
        on top of Free Fire. The Platform does not own, operate, or control Free
        Fire's game servers, matchmaking systems, or any other Garena
      ...
      >
        <li>
          The Platform is not liable for Free Fire server downtime, maintenance
          windows, or outages that prevent players from joining custom rooms or
          completing matches.
        </li>
        <li>
        ...
        <li>
          If Garena's servers experience downtime during an Arena that prevents
          all registered players from completing the match — the Platform will
          assess the situation and, where possible, work with the Organiser to
          reschedule the match. If rescheduling is not possible, entry fees will
          be refunded per the Money Deposit &amp; Receive Policy.
        </li>
        <li>
          ...
          advised to check Garena's official channels for scheduled maintenance
          information before registering for arenas scheduled close to known
          maintenance windows.
        </li>
      </ul>
      <h2
      ...
      >
        <li>
          Device crashes, overheating, battery failure, or hardware malfunction
          during the match — not the Platform's responsibility.
        </li>
        <li>
          Internet connectivity loss, high latency, packet loss, or ISP outages
          experienced by a player during the match — not the Platform's
          responsibility.
        </li>
        <li>
      ...
      >
        <li>
          ...
          via in-app support within 30 minutes of the scheduled match start time
          to report the missing Room Card.
        </li>
        <li>
          The Platform will investigate and attempt to obtain the Room Card from
          the Organiser or work with the Organiser to reschedule the match.
        </li>
        <li>
          If the match cannot proceed due to the Organiser's failure to provide
          the Room Card — the Arena will be cancelled and full refunds issued
          per the Money Deposit &amp; Receive Policy.
        </li>
        <li>
          The Organiser may face consequences under the Organiser Agreement and
          their organiser subscription terms for failure to fulfil their Arena
      ...
      >
        <strong>
          ...
          report a missing Room Card. If you have not received the Room Card 25
          minutes before the scheduled start — contact support immediately. Late
          reports may not allow sufficient time to resolve the issue before the
          match start.
        </strong>
      </p>
      <p
      ...
      >
        The following is the complete consolidated reference list of all conduct
        prohibited in connection with Corpse Arenas. Each item references the
        relevant section of these Arena T&amp;C and the consequence that
        applies:
      </p>
      <div style={{ overflowX: "auto", marginBottom: "32px" }}>
        <table
        ...
        >
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Second registration rejected by system.
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Allowing another person to play on your behalf (account sharing)
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Using cheats, hacks, aimbots, wallhacks, or prohibited software
              </p>
            </td>
            <td
              style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                Dispute dismissed + potential flag.
              </p>
            </td>
          </tr>
          </tbody>
      ...
      >
        ...
        all applicable provisions of the Indian Penal Code, as amended from time
        to time. These Arena T&amp;C operate within and supplement the Corpse
        Terms &amp; Conditions of the Corpse platform.
      </p>
      <h2
        style={{
          fontFamily: "var(--font-ui)",
      ...
      >
        ...
        entry fee refunds, or prize disbursements — shall be handled as follows:
      </p>
      <ul
        style={{
          listStyle: "disc",
      ...
      >
        ...
        <li>
          ...
          through good-faith negotiation by contacting{" "}
          <a
            href="mailto:support@corpsearena.com"
            style={{ color: "var(--red)" }}
          >
          ...
          The seat of arbitration shall be Guwahati, Assam, India.
        </li>
      </ul>
      <h2
        style={{
          ...
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
            ...
            >
              ...
              >
                ...
                via in-app — report at least 25 mins before match start
              </p>
            </td>
          </tr>
          <tr style={{ borderBottom: "1px solid var(--g200)" }}>
